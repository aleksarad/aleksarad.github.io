...
function Footer() {
  return (
    <footer>
        <a href="https://github.com/aleksarad" target="_blank">
        ...
        <a href="https://medium.com/@alexa.radevich1_8991" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
          className="icons"
          width="80" height="80"
          viewBox="0 0 172 172"
        ...
        <a href="https://www.linkedin.com/in/alexandra-radevich/" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
          className="icons"
          width="80" height="80"
          viewBox="0 0 172 172"
